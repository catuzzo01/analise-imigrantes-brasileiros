...
A base de dados utilizada, [`imigrantes_canada.csv`](imigrantes_canada.csv) / [`imigrantes_canada.csv`](imigrantes_canada.csv), contém informações sobre o número de imigrantes de diversos países para o Canadá, segmentados por ano. Os principais campos incluem país de origem, ano e quantidade de imigrantes.

## Bibliotecas Utilizadas

As principais bibliotecas utilizadas, listadas em [`requirements.txt`](requirements.txt), são:

1. [pandas](https://pandas.pydata.org/) – Manipulação de dados.  
...
![Imigração na América do Sul](imagens/imigracagito_america_sul.png)
